...
# prepare dirs
#-------------------------------------------
mkdir -p /tb2/build-devomd/$RELNAME-lua-resty-lrucache
rm -rf /tb2/build-devomd/$RELNAME-lua-resty-lrucache/*deb
...
# build
#-------------------------------------------
BUILDDIR="/root/src/lua-resty-lrucache/git-lua-resty-lrucache"
cd $BUILDDIR
...
find -L /root/src/lua-resty-lrucache -maxdepth 3 -type f -iname "*udeb" -delete
find -L /root/src/lua-resty-lrucache -maxdepth 3 -type f -iname "*dbgsym*deb" -delete


# upload to /tb2/build-devomd/{$RELNAME}-nginx
#-------------------------------------------
mkdir -p /tb2/build-devomd/$RELNAME-lua-resty-lrucache
cp *.deb /tb2/build-devomd/$RELNAME-lua-resty-lrucache/ -Rfav
ls -la /tb2/build-devomd/$RELNAME-lua-resty-lrucache/
