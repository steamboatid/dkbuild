...
PREPEND CFLAGS -O3  -ldl -lstdc++ -lm -lresolv --whole-archive
PREPEND CPPFLAGS -O3 -lstdc++
PREPEND CXXFLAGS -O3  -ldl -lstdc++ -lm -lresolv --whole-archive
PREPEND LDFLAGS -O3  -ldl -lstdc++ -lm -lresolv --whole-archive
...
prepare_build_flags() {
	...
	CFLAGS="${AAA/$GO2/$OPT3} -ldl -lstdc++ -lm -lresolv --whole-archive"
	export CFLAGS
