...
# ssh argo -- lxc-attach -n bus -- /bin/bash /tb2/build/dk-prep-deps-php8.sh "php8.1"

# ssh argo -- lxc-attach -n bus -- /bin/bash /tb2/build/dk-prep-core-php8.sh "php8.0"
# ssh argo -- lxc-attach -n bus -- /bin/bash /tb2/build/dk-prep-deps-php8.sh "php8.0"
...
ssh argo -- lxc-attach -n bus -- /bin/bash dk-build-full.sh -d /root/src/php/php-ps-1.4.1
